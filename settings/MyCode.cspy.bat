...
"D:\pf\iar3.2\common\bin\cspybat" "D:\pf\iar3.2\SAM8\bin\sam8proc.dll" "D:\pf\iar3.2\SAM8\bin\sam8sim.dll"  %1 --plugin "D:\pf\iar3.2\SAM8\bin\<libsupport_plugin>" --backend -B "-ef" "FF" "--core" "sam8xrc" "-p" "D:\pf\iar3.2\SAM8\config\iosam8xrc.ddf" "-d" "sim" 
